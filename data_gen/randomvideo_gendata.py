...
def gendata(data_path, out_path, ignored_sample_path=None, part='eval'):
    ...
    for video in sample_videos:
        video = str(video)
        video_annotation_file = 'volleyball_section{}.txt'.format(video)
        video_annotation_file_path = os.path.join(data_path, video_annotation_file)
        with open(video_annotation_file_path, 'r') as f:
            lines = f.readlines()
            for line in lines:
                line_list = line.split()
                file_name ="volleyball_section{}/{}_41.npy".format(video, line_list[0]) 
...
if __name__ == '__main__':
    ...
    parser.add_argument('--data_path', default='/mnt/pci-0000:00:17.0-ata-6/dataset/random_video')
    parser.add_argument('--ignored_sample_path',
                        default='../data/nturgbd120_raw/NTU_RGBD120_samples_with_missing_skeletons.txt')
    parser.add_argument('--out_folder', default='data/random_video_basketball')
