...
class Model(nn.Module):
    def __init__(self, num_class=60, num_point=25, num_person=2, graph=None, graph_args=dict(), in_channels=6, distillation=False):
        ...
        self.l1 = TCN_GCN_unit(6, 64, A, residual=False, sage=False)
        self.l2 = TCN_GCN_unit(64, 64, A)
        self.l3 = TCN_GCN_unit(64, 64, A)
        self.l4 = TCN_GCN_unit(64, 64, A)
        self.l5 = TCN_GCN_unit(64, 128, A, stride=2, sage=False)
        self.l6 = TCN_GCN_unit(128, 128, A)
        self.l7 = TCN_GCN_unit(128, 128, A)
        self.l8 = TCN_GCN_unit(128, 256, A, stride=2, sage=False)
        self.l9 = TCN_GCN_unit(256, 256, A)
        self.l10 = TCN_GCN_unit(256, 256, A, sage=False)

        self.fc = nn.Linear(256, num_class)
        self.fc_single = nn.Linear(256, 10)
        ...
        self.fc_jigsaw = nn.Linear(256, 128)
    ...
    def forward(self, x):
        ...
        # # jigsaw
        # group_x_a = self.jigsaw_head(group_x)
        # return self.fc(group_x), 0, group_x, single_x_feature
