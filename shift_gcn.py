...
class Model(nn.Module):
    def __init__(self, num_class=60, num_point=25, num_person=2, graph=None, graph_args=dict(), in_channels=9, distillation=False):
        ...
        self.l1 = TCN_GCN_unit(9, 64, A, residual=True, sage=True)
        ...
        self.fc_single = nn.Linear(256, 7)
